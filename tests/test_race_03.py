...
@pytest.fixture
def course_03(caltopo_map_03, race_03_config):
    return course.Course(
        caltopo_map_03,
        race_03_config["aid_stations"],
        "Route 03",
        race_03_config["route_distance"],
    )
